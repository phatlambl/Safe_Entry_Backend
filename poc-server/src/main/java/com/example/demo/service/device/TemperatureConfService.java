...
public class TemperatureConfService {
	...
	@Autowired
	public TemperatureConfService(DeviceRepository deviceRepository, DeviceLogRepository deviceLogRepository, Map map,
			TemperatureRepository temperatureRepository, EmailConfigRepository emailConfigRepository) {
